...
import 'widgets/movies2_item_widget.dart';
    ...
    return SizedBox(
        ...
        child: Obx(() => ListView.separated(
            ...
            itemCount: controller
                .detailPageTenModelObj.value.movies2ItemList.value.length,
            itemBuilder: (context, index) {
              Movies2ItemModel model = controller
                  .detailPageTenModelObj.value.movies2ItemList.value[index];
