...
import 'widgets/exploregrid_item_widget.dart';
        ...
        child: Padding(
            ...
            child: Obx(() => GridView.builder(
                ...
                itemCount: controller
                    .exploreSixModelObj.value.exploregridItemList.value.length,
                itemBuilder: (context, index) {
                  ExploregridItemModel model = controller.exploreSixModelObj
                      .value.exploregridItemList.value[index];
